        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full bg-gray-800 border rounded-lg px-3 py-2 text-white placeholder-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 transition ${errors.name ? 'border-red-500' : 'border-gray-600'}`}
            />
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="9.99"
                className={`w-full bg-gray-800 border rounded-lg px-3 py-2 text-white placeholder-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 transition ${errors.cost ? 'border-red-500' : 'border-gray-600'}`}
              />
            ...
            <div className="flex-1">
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 transition"
              >
          ...
          {/* Next Billing Date */}
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1">Next Billing Date</label>
            <input
              name="nextBillingDate"
              type="date"
              value={form.nextBillingDate}
              onChange={handleChange}
              className={`w-full bg-gray-800 border rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 transition ${errors.nextBillingDate ? 'border-red-500' : 'border-gray-600'}`}
            />
            {errors.nextBillingDate && <p className="mt-1 text-xs text-red-400">{errors.nextBillingDate}</p>}
          </div>
